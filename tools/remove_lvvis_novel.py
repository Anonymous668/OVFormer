...
if __name__ == '__main__':
    ...
    parser.add_argument('--ann', default='datasets/LVVIS/train/train_instances.json')
    ...
    print('norare #anns', len(data['annotations']))  # 10884
    out_path = args.ann[:-5] + '_nonovel.json'
